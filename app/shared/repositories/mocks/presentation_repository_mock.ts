...
export class PresentationRepoMock implements IPresentationRepository {
    ...
    async getPresentationByStudentId(studentId: string): Promise<Presentation[] | null> {
        // it doesn't make sense to implement this method in the mock for now
        throw new BadRequestException("Not implemented yet");
    }

    async getPresentationByExaminatorId(examinatorId: string): Promise<Presentation[] | null> {
        // it doesn't make sense to implement this method in the mock for now
        throw new BadRequestException("Not implemented yet");
    }
