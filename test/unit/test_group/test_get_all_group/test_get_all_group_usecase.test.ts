...
describe("GetAllGroupUseCase", () => {
    ...
    beforeEach(() => {
        ...
        usecase = new GetAllGroupsUseCase(groupRepo, userRepo, projectRepo, partnerRepo);
    });
    ...
    it("should return all groups with user names and project titles", async () => {
        ...
        expect(result[5].project.title).toBe("Fazendo circuitos com a GM");
        expect(result[5].project.partnerName).toBe("General Motors");
        expect(result[5].project.extensionHours).toBe(undefined);
