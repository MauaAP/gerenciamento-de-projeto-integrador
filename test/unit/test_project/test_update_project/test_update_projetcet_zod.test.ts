...
describe("UpdateProjectSchema -Zod validation", () => {
    ...
    it("should throw (O título deve conter pelo menos 6 caracteres) if title has less than 6 characters", () =>{
        try {
    ...
    it("should throw (As horas de extensão devem ser dadas em numero de horas (number)) if extensionHours is not a number", () =>{
        try {
    ...
    it("should throw (O numero de horas de extensão deve ser maior que 0) if extensionHours is a negative number", () =>{
        try {
